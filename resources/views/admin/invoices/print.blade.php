...
<head>
    ...
    <!-- Muat Tailwind CSS agar visual tetap konsisten super elegan -->
    @vite(['resources/css/app.css'])
</head>
<body class="bg-white text-gray-800 antialiased min-h-screen flex items-start justify-center pt-6 bg-gray-50/30 print:bg-white print:pt-0">

{{-- KONTEN UTAMA STRUK --}}
<div class="w-[460px] bg-white p-6 border border-gray-200 shadow-sm print:border-none print:shadow-none">

    {{-- KOP NOTA --}}
    <div class="text-center border-b-2 border-dashed border-gray-200 pb-4 mb-4 relative">
        <h4 class="text-base font-black tracking-widest text-blue-600 uppercase">WEBELIJABAH</h4>
        <p class="text-[10px] text-gray-400 font-bold mt-0.5">Batam, Indonesia — Invoice</p>
    ...
    <div class="space-y-2">
        ...
        @empty
            <p class="text-white text-[11px] text-gray-400 italic text-center py-3 bg-white rounded-lg border border-gray-100 border-dashed">
...
{{-- AUTOMATIC PRINT ENGINE TRIGGER --}}
<script>
    window.addEventListener('DOMContentLoaded', () => {
        // Beri jeda 500ms agar style CSS Vite terkompilasi sempurna terlebih dahulu
        setTimeout(() => {
            window.print();

            // Opsional: Tutup tab otomatis setelah user selesai menekan tombol/save PDF
